...
# Scheitelpunkt markieren, den die Bildunterschrift nennt
ax.axvline(13.43, linestyle=":", color="grey", linewidth=1)

# Dezimalkomma auf beiden Achsen
import matplotlib.ticker as mticker
ax.yaxis.set_major_formatter(
    mticker.FuncFormatter(lambda v, _: f"{v:.1f}".replace(".", ","))
)
...
fig.tight_layout()
save(fig, "Abbildung_9_h2_indirekte_effekte")
...
fig.tight_layout()
save(fig, "Abbildung_10_h3_mediationsmodell")
...
fig.tight_layout()
save(fig, "Abbildung_11_h4_fairness_reaktanz")
